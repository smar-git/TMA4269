...
We give you a 15 minutes heads up today

## What WE learnt on Wednesday

<br> <br>

You are not AI/prompt experts (yet)
...
-   A good visualization is rarely the first one, you need to keep asking questions to the data
...
Data analytics projects are full of uncertainties, ambiguities and numerous challenges such as:

-   unclear decision objectives
...
August 2025: Norwegian newspaper VG presents a story with the headline: "Young women with a master's degree are on sick leave far more than men".

They show that: "The higher the level of education, the greater the gender difference in sick leave"
...
Discuss the VG article (header and visualization) \[*2 min first thoughts on post-its!*\]. Why do you think this story was successful? How do you interpret the numbers in the figure?
...
::: {.column width="65%"}
-   Reality: What is it we are trying to describe?
